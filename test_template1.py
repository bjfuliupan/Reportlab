...
def test_pdf():
    ...
    try:
        ...
        PDFTemplate.set_line_chart_data(pages, 0, "line_chart",
            ...
            legend_names=["乒乓球", "篮球", "排球", "足球", "乒乓球", "篮球", "排球", "足球", "乒乓球", "篮球", "排球", "足球"])

        # 设置柱状图的数据
        PDFTemplate.set_bar_chart_data(
            pages, 0, "bar_chart", [(170, 165, 167, 172, 176, 180, 160, 166, 170, 165, 167, 172, 176, 180, 160, 166), (60, 65, 55, 58, 70, 72, 68, 80, 60, 65, 55, 58, 70, 72, 68, 80)],
