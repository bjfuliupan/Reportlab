...
if __name__ == "__main__":
    ...
    #     "items": {
    #         "title":
    #             {"page_num": 0, "type": "text", "rect": [90, 800, 450, 30], "position": "middle",
    #              "font_color": colors.gray, "font_size": 20, "content": "刘攀的第一个PDF测试文档"},
    #         "description":
    #             {"page_num": 0, "type": "paragraph", "rect": [90, 700, 450, 50],
    #              "font_size": 12, "indent_flag": 1,
    #              "content": "刘攀的第一个PDF测试文档。 第１行我们导入Paragraph和SimpleDocTemplate类。"
    #                         "Paragraph是用于生成文本段落的。SimpleDocTemplate是文档布局模板。从上面的例子可以"
    #                         "看到通过文档模板及样式可以让我们方便的创建面向对象的应用，而不用再关心坐标、绘制命"
    #                         "令等底层的东西，从而可以方便我们的文档生成。打开hello.pdf看一看效果吧。这回就象是"
    #                         "真正的文档，\"Hello\"放在上面了。"},
    #         "line_chart":
    #             {"page_num": 0, "type": "line_chart", "category_names": lc_cats1, "data": lc_values1,
    #              "rect": [100, 450, 430, 200], "legend_names": ["乒乓球", "篮球", "排球", "足球"],
    #              "main_title": "每月消费数量示意图", "main_title_font_size": 15, "x_desc": "月份",
    #              "y_desc": "数量"},
    #         "bar_chart":
    #             {"page_num": 0, "type": "bar_chart", "category_names": bc_cats1, "data": bc_values1,
    #              "rect": [100, 200, 430, 200], "legend_names": ["身高", "体重"], "bar_style": "vertical",
    #              "main_title": "探针组身体状况示意图", "main_title_font_size": 15, "x_desc": "姓名",
    #              "y_desc": "身高/体重"}
    #     }
    # }
    #
    # try:
    #     PDFTemplate.draw(template1)
    # except Exception as err:
    #     print(err)
    #
    # template1_ = {"pdf": template1}
    # xml_str = xmltodict.unparse(template1_)
    # with open("template1.xml", "w") as f:
    #     f.write(xml_str)
    #
    # with open("template1.xml", "r") as f:
    #     con = f.read()
    #
    # xx = xmltodict.parse(con)
    # print(xx)
